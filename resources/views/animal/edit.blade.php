...
<div class="card mt-4">
    <div class="card-body">
        ...
        <h5 class="card-title fw-bolder mb-3">Ubah Data Animal</h5>

        <form method="post" action="{{ route('animal.update', $data->animal_id) }}">
            @csrf
            <div class="mb-3">
                <label for="animal_id" class="form-label">Animal ID</label>
                <input type="text" class="form-control" id="animal_id" name="animal_id" value="{{ $data->animal_id }}">
            </div>
            <div class="mb-3">
                <label for="species" class="form-label">Species</label>
                <input type="text" class="form-control" id="species" name="species" value="{{ $data->species }}">
            </div>
            <div class="mb-3">
